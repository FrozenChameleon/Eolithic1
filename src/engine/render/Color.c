...
const Color COLOR_MUTE_DGRAY = {102, 102, 102};
const Color COLOR_MUTE_LGRAY = {172, 172, 172};
const Color COLOR_MUTE_RED = {181, 48, 31};
const Color COLOR_MUTE_DARKRED = {107, 8, 0};
const Color COLOR_MUTE_DARKERRED = {64, 5, 0};
const Color COLOR_MUTE_YELLOW = {234, 158, 33};
const Color COLOR_CYAN = {0, 255, 255};
const Color COLOR_LIGHT_GRAY = {191, 191, 191};
...
const Color COLOR_ORANGE = {255, 164, 0};
...
const Color COLOR_PINK = {255, 191, 202};
const Color COLOR_CORNFLOWER_BLUE = {99, 148, 237};
const Color COLOR_PURPLE = {127, 0, 127};
const Color COLOR_VIOLET = {237, 130, 237};
const Color COLOR_COMETSTRIKER_BLUE = {0, 128, 205};
const Color COLOR_COMETSTRIKER_GREEN = {18, 148, 0};
const Color COLOR_COMETSTRIKER_RED = {255, 63, 63};
const Color COLOR_COMETSTRIKER_PINK = {255, 0, 240};
const Color COLOR_COMETSTRIKER_BORDER_INNER_GRAY = {166, 166, 166};
const Color COLOR_COMETSTRIKER_BORDER_OUTER_GRAY = {76, 76, 76};
