...
{
	GAME_STATE_MANAGER_DEBUG_INFO_SHOW_NOTHING = 0,
	GAME_STATE_MANAGER_DEBUG_INFO_SHOW_QUICK_STATS = 1,
	GAME_STATE_MANAGER_DEBUG_INFO_SHOW_THING_VIEWER = 2
};

enum GameStateManagerGameState
{
	GAME_STATE_MANAGER_GAME_STATE_NORMAL = 0,
	GAME_STATE_MANAGER_GAME_STATE_PAUSED = 1
};
