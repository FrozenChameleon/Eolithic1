...
typedef void (*SystemFunc_DrawHudHelperFunc)(Entity owner, void* data, SpriteBatch* spriteBatch);
typedef void (*SystemFunc_DrawDebugHudHelperFunc)(Entity owner, void* data, SpriteBatch* spriteBatch);
